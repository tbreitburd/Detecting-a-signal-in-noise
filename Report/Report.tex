...
Doing so, 2 hypothesis are being fitted to the samples, and we can obtain the minimised negative log-likelihood values for each of those fits. Now comes the hypothesis testing part. The test statistic used here is the difference between the 2 minimised negative log-likelihood values, or the likelihood ratio. 

% explain how we get p-value from iminuit outputs

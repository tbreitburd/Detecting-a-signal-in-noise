...
\begin{figure}[tp]
    \centering
    \includegraphics[width=\textwidth]{/Users/thomasbreitburd/Documents/CAMBRIDGE/Study/Principles_of_DS/Coursework/tmb76/Plots/plot_f.png}
    \captionsetup{margin=1.3cm}
...
\begin{figure}[tp]
    \centering
    \includegraphics[width=\textwidth]{/Users/thomasbreitburd/Documents/CAMBRIDGE/Study/Principles_of_DS/Coursework/tmb76/Plots/plot_g.png}
    \captionsetup{margin=1.3cm}
    \caption[width=0.2\pdfpagewidth]{Plot of the discovery rate as a function of the sample size (blue line). The red line shows the 90\% goal}
\end{figure}
...
\begin{figure}[tp]
    \centering
    \includegraphics[width=\textwidth]{/Users/thomasbreitburd/Documents/CAMBRIDGE/Study/Principles_of_DS/Coursework/tmb76/Plots/plot_pdf_g.png}
    \captionsetup{margin=1.3cm}
    \caption[width=0.2\pdfpagewidth]{Plot of the total p.d.f.\ of the model, signal, and background, normalised for $M\in{[5,5.6]}$.}
\end{figure}
